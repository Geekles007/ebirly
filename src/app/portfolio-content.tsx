...
const STACK = [
  ...
  { n: 'TypeScript',     m: 'Language · Strict',         l: 0.90, s: 'span-4' },
  { n: 'Node.js',        m: 'Runtime · API',             l: 0.80, s: 'span-3' },
  ...
  { n: 'GraphQL',        m: 'API · Schema',              l: 0.80, s: 'span-4' },
  { n: 'Docker',         m: 'Container · DevOps',        l: 0.70, s: 'span-3' },
  ...
  { n: 'Microfrontends', m: 'Architecture · Modular',    l: 0.80, s: 'span-4' },
];

const PROJECTS = [
  { t: 'Ibird Agency',        tg: ['Next.js', 'Dribbble API', 'GSAP'],         y: '2024', th: 'Design studio · Portfolio',          h: 'https://ibirdagency.com/' },
  { t: 'Emplacement Immo',    tg: ['Next.js', 'Python', 'Vercel'],             y: '2024', th: 'Real estate · Lokimo platform',       h: 'https://emplacement.immo/' },
  { t: 'Environnement Macif', tg: ['Next.js', 'TypeScript', 'GSAP'],           y: '2023', th: 'Real estate · Macif.fr',              h: 'https://environnement-immobilier.macif.fr/' },
  { t: 'Lokimo AI',           tg: ['Next.js', 'TypeScript', 'Framer Motion'],  y: '2023', th: 'SaaS · AI real estate platform',      h: 'https://www.lokimo.ai' },
  { t: 'Henspiration',        tg: ['React', 'Spotify API', 'Node.js'],         y: '2022', th: 'Music · Artist promotion app',        h: 'https://henspiration.vercel.app' },
  { t: 'IFCameroun',          tg: ['Next.js', 'Strapi', 'AWS'],                y: '2022', th: 'Editorial · Institut Français',       h: 'https://www.ifcameroun.com' },
];

const CERTS = [
  { t: 'Animations on the Web',               c: 'Animations.dev', y: '2024', h: 'https://animations.dev/certificate/c015f445-d180-4146-8617-9e8fbd8da936' },
  { t: 'Apollo Graph Developer — Associate',  c: 'Apollo GraphQL', y: '2023', h: 'https://www.apollographql.com/tutorials/certifications/5fd2321a-c700-4412-b393-ee56eb88ffde' },
  { t: 'Front End Libraries',                 c: 'freeCodeCamp',   y: '2022', h: 'https://www.freecodecamp.org/certification/fcc182b6d0f-8bee-4f97-aed9-2c166a2ca5c1/front-end-development-libraries' },
  { t: 'JS Algorithms & Data Structures',     c: 'freeCodeCamp',   y: '2022', h: 'https://www.freecodecamp.org/certification/fcc182b6d0f-8bee-4f97-aed9-2c166a2ca5c1/javascript-algorithms-and-data-structures' },
  { t: 'Microfrontends with React',           c: 'Udemy',          y: '2021', h: 'https://www.udemy.com/certificate/UC-931e7037-dfd7-4266-8d7e-1040b9012da1/' },
  { t: "NestJS: The Complete Developer's Guide", c: 'Udemy',        y: '2025', h: 'https://www.udemy.com/certificate/UC-f42d1e15-1e1e-4cc5-b9d6-c5d0a41e016c/' },
];
...
const LINKS = [
  ...
  { l: 'LinkedIn', v: '/in/lee-tondji-niat',   h: 'https://www.linkedin.com/in/lee-tondji-niat/' },
...
const MARQUEE_ITEMS = [
  'React', 'Next.js', 'TypeScript', 'Node.js', 'Framer Motion',
  'GSAP', 'Tailwind', 'GraphQL', 'Docker', 'AWS', 'Figma',
  'Affinity Designer', 'Angular', 'Spring Boot', 'Flutter', 'NestJS',
];
    ...
    <>
        ...
        <div className="wrap">
          ...
          <div className="status-card rise" style={{ animationDelay: '.4s' }}>
            <div className="s-head">
              <b>{t.status.title}</b>
              <span><i className="status-pulse" />{t.status.online}</span>
            </div>
            {t.status.rows.map(([k, v]) => (
              <div className="s-row" key={k}><span>{k}</span><b>{v}</b></div>
            ))}
          </div>
          ...
          <h1 className="rise" style={{ animationDelay: '.05s' }}>
            {t.hero.l1}<br />
            <span className="outline">{t.hero.l2}</span><br />
            <span>{t.hero.l3}<span className="slash">_</span></span>
          </h1>
          ...
          <div className="hero-actions rise" style={{ animationDelay: '.3s' }}>
            <a className="btn primary" href="#work">{t.hero.cta1}</a>
            <a className="btn" href="#contact">{t.hero.cta2}</a>
            <span className="chip" style={{ marginLeft: 'auto' }}>{t.hero.scroll}</span>
          </div>
        </div>
      </section>
      ...
      <section id="about" className="section-anchor">
        <div className="wrap">
          ...
          <div className="about-grid">
            <div>
              <h2 className="sec-title" style={{ marginBottom: 36 }}>{t.about.title}</h2>
              <p className="lede">
                {t.about.intro} <u>Tondji Niat J. Lee</u>{t.about.lede_pre}{' '}
                <em>{t.about.lede_em}</em>{' '}
                {t.about.lede_post}
              </p>
            </div>
      ...
      <section id="stack" className="section-anchor">
        <div className="wrap">
          ...
          <h2 className="sec-title" style={{ marginBottom: 48 }}>{t.stack.title}</h2>
          <div className="stack-grid">
            {STACK.map((x, i) => (
              ...
              >
                <div className="sc-idx">{String(i + 1).padStart(2, '0')} / {STACK.length}</div>
                <div>
                  <div className="sc-name">{x.n}</div>
                  <div className="sc-meta">{x.m}</div>
                  <div className="sc-bar"><i /></div>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="work" className="section-anchor">
        <div className="wrap">
          ...
          <h2 className="sec-title" style={{ marginBottom: 48 }}>{t.work.title}</h2>
          <div className="projects-list">
            {PROJECTS.map((p, i) => (
              ...
              >
                ...
                <div className="p-tags">{p.tg.map((tag, j) => <span key={j}>{tag}</span>)}</div>
        ...
        <div className="wrap">
          ...
          <div className="exp-grid">
            <div>
              ...
              <p className="hero-desc" style={{ marginTop: 24 }}>{t.exp.side}</p>
            </div>
            <div>
        ...
        <div className="wrap">
          ...
          <div className="exp-grid">
            <div>
              ...
              <p className="hero-desc" style={{ marginTop: 24 }}>{t.edu.side}</p>
            </div>
            <div>
                ...
                <div className="exp-item" key={i}>
                  ...
                  <div>
                    <h4 className="exp-role">
                      <a href={it.h} target="_blank" rel="noopener noreferrer"
      ...
      <section id="certs" className="section-anchor">
        <div className="wrap">
          ...
          <h2 className="sec-title" style={{ marginBottom: 48 }}>{t.certs.title}</h2>
          <div className="stack-grid">
            {CERTS.map((c, i) => (
              <a
                key={i}
              ...
              >
                <div className="sc-idx">{String(i + 1).padStart(2, '0')} / {CERTS.length}</div>
                <div>
                  <div className="sc-name" style={{ fontSize: 16 }}>{c.t}</div>
                  <div className="sc-meta">{c.c} · {c.y}</div>
                  <div className="sc-bar"><i /></div>
                </div>
              </a>
            ))}
          ...
          <div className="stack-grid">
            {LANGS_DATA.map((lang, i) => (
              <div key={i} className="stack-cell span-3">
                <div className="sc-idx">{String(i + 1).padStart(2, '0')} / {LANGS_DATA.length}</div>
                <div>
        ...
        <div className="wrap">
          ...
          <div className="contact-grid">
            ...
            <div className="contact-links">
              {LINKS.map((link, i) => (
                <a key={i} href={link.h} target="_blank" rel="noopener noreferrer">
